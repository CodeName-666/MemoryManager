#ifndef MEMORY_MANAGER_DEBUG_IF_H
#define MEMORY_MANAGER__DEBUG_IF_H
...
#if defined (DEBUG)
#define DBIF_SERIAL                               1u
#define DBIF_TELNET                               2u


#define DBIF_INTERFACE  DBIF_SERIAL
...
/*--- Required DBIF Flags ------------------------------------------------*/
  ...
  #define DBIF_LOGLEVEL                             LOG_DEBUG_3

  #define DBIF_MODULE_NAME                          "MemoryManager"


#if DBIF_INTERFACE == DBIF_SERIAL
/**
...
/**
  ...
  */
  ...
  #elif DBIF_INTERFACE == DBIF_TELNET
 ...
 * 
 */
#define DBIF_INIT(args...)                      TelnetStream.begin(args)
...
/**
  ...
  * If a other print function is required, this flag can be used.
  */
  #define DBIF_PRINTF_FUN                          TelnetStream.printf
